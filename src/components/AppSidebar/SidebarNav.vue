  ...
  <div class="sidebar-nav">
    ...
    <div class="playlist">
      ...
      <ul class="actions">
        ...
        <RouterLink tag="li" to="/collection/tracks" class="liked-songs action">
  ...
  .nav-list {
    ...
    a {
      ...
      &.router-link-exact-active {
        background-color: var(--color-inverted-14);
